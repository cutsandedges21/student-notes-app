...
export function FormattingToolbar({
  ...
  return (
    <div
      ...
      className="grid shrink-0 grid-cols-[1fr_auto_1fr] items-center gap-2 relative z-20 bg-surface px-3 pb-1.5 pt-0.5 shadow-pill lg:pl-[calc(var(--ai-panel-w)+0.75rem)]"
    >
      {/*
